...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb-project", type=str, default="TOM-LoRA-SFT")
    ...
    parser.add_argument("--data-path", type=str, default="dataset/lora_medical.jsonl")
    parser.add_argument("--lora-name", type=str, default="lora_medical", help="根据任务保存成lora_(英文/医学/心理...)")
    ...
    args.wandb_run_name = f"TOM-Lora-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
