...
def dpo_loss(ref_probs, probs, mask, beta):
    ...
    # https://github.com/jingyaogong/TOM/issues/298
...
if __name__ == "__main__":
    ...
    lm_config = TOMConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=args.use_moe)
    ...
    args.wandb_run_name = f"TOM-Full-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
